...
export default function Onboarding_Alert_Modal(props) {
  return (
    <div
      className={`alert-modal-wrapper flex flex-row justify-between items-center gap-[16px] max-w-[730px] h-[60px] py-3 px-5 border rounded-lg ${props.border} ${props.background} ${props.isVisible}`}
    >
