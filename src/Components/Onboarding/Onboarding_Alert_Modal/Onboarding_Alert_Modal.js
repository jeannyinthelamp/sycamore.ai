  ...
  return (
    ...
    >
      <div className='alert-modal-left flex flex-row justify-center items-center gap-4 w-fit h-8'>
        ...
        <p className=' min-w-auto font-Roboto-Flex font-normal text-[16px] text-[#000] leading-normal select-none'>
          {props.message}
        </p>
      </div>
      <div className='alert-modal-right flex flex-row justify-center items-center gap-5 w-fit h-8'>
        <button
          ...
          className={`py-[6px] px-3 bg-[#000] rounded-lg font-Roboto-Flex text-center text-[#FFF] text-[14px] font-medium leading-6 cursor-pointer hover:bg-[#1D2E99] transition-colors duration-200 ease-in-out ${
