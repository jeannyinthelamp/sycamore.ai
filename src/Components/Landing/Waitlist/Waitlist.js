    ...
    <section className='waitlist-outer-wrapper w-screen h-auto flex justify-center items-center bg-[#FFF]'>
      <div className='waitlist-inner-wrapper relative w-[1440px] h-[800px] flex justify-center items-center'>
            ...
            <div className='first-last-names-wrapper flex flex-row'>
              <label className='flex flex-col font-[Inter] text-[#6C757D] text-[14px] font-normal leading-[24px]'>
                ...
                <input
                  ...
                  type='text'
                  name='first-name'
                  className=' w-[191px] h-auto mt-[8px] mr-[17px] py-[10px] px-[16px] outline outline-1 outline-[#CED4DA] rounded-[8px]'
                />
              </label>
              <label className='flex flex-col font-[Inter] text-[#6C757D] text-[14px] font-normal leading-[24px]'>
                Last Name
                <input
                  ...
                  type='text'
                  name='last-name'
                  className='w-[191px] h-auto mt-[8px] py-[10px] px-[16px] outline outline-1 outline-[#CED4DA] rounded-[8px]'
                />
              </label>
            </div>
            {/* //* email to submit button wrapper */}
            <div className='form-email-button-wrapper w-auto h-auto mt-[32px] flex flex-col justify-center items-center'>
              <label className='flex flex-col font-[Inter] text-[#6C757D] text-[14px] font-normal leading-[24px]'>
                ...
                <input
                  ...
                  name='email'
                  required
                  className=' w-[400px] h-auto mt-[8px] py-[10px] px-[16px] outline outline-1 outline-[#CED4DA] rounded-[8px]'
                />
              </label>
              {/* //* Toggle here */}
              <div className='toggle-wrapper mt-[33.5px] flex flex-row '></div>
        ...
        <img
          ...
          className='absolute z-0 top-[25%] left-[17.6%]  w-[385px] h-[399px]'
        />
        <img
          //
          src={smart_people_right}
          alt='artist painting'
          className='absolute z-0 bottom-[22%] right-[20.4%] w-[209px] h-[242px]'
        />
      </div>
    </section>
  );
