    ...
    <footer className=' h-[369px] flex flex-col  items-center  bg-[#212529]'>
      ...
      <div className='footer-top-section w-[100%] max-w-[1440px] flex flex-col justify-center items-center gap-[10px] pt-[100px] px-[165px]'>
        ...
        <div className='logo-links-wrapper w-[100%] pb-[42px] flex flex-1 justify-between items-center self-stretch border-b border-solid border-[#495057]'>
          ...
          <div className='flex items-start gap-[54px] font-Poppins text-[#F8F9FA] text-[16px] font-normal leading-normal'>
            <Link to='' className=''>
              Features
            </Link>
            <Link to='' className=''>
      ...
      <div className='footer-bottom-section w-[100%] max-w-[1440px] flex flex-col justify-center items-start pt-[42px] px-[165px] pb-[114px] '>
        ...
        <div className='copyright-links-wrapper w-[100%] flex justify-between items-center self-stretch font-Poppins text-[#F8F9FA] text-[16px] font-medium leading-[21px] '>
          <p className='text-[14px]'>@2023 CR8T Studio. All Rights Reserved.</p>
          {/*  Wrapper for bottom links */}
          <div className='flex items-start gap-[54px] font-Poppins text-[#ADB5BD] text-[16px]  leading-normal'>
            <Link to='' className=''>
              Privacy Policy
            </Link>
            <Link to='' className=''>
