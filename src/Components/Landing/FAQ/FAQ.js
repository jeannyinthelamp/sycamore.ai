...
const faqdata = [
  ...
  },
  {
    id: 4,
    title:
      "Is there a free trial available for Syne, and what pricing options and plans does Syne offer?",
    description:
  ...
  },
  {
    id: 5,
    title:
      "Can I invite clients and external stakeholders to collaborate on projects?",
    description:
...
function Icon({ id, open }) {
  ...
  return (
    ...
    >
      <circle cx='12' cy='12.6689' r='8' stroke='#212529' strokeWidth='1.5' />
      {getIconPath()}
    </svg>
  );
}
...
const FAQ = () => {
  ...
  return (
    <div className='bg-[#FAFAFF]'>
      <div className='px-[165px] py-[137px]'>
        <div className='FAQ-title-text-wrapper max-w-[571px] mb-[48px] font-Poppins'>
          ...
          <h1 className=' font-semibold text-[40px] text-[#292421] leading-[54px]'>
        ...
        {faqdata.map((data) => (
          <Accordion
            ...
            icon={<Icon id={data.id} open={openItems.includes(data.id)} />}
          ...
          >
            ...
            <AccordionBody className=' font-[Poppins] gap-[10px] leading-6 text-base text-[#212529]'>
              {data.description}
            </AccordionBody>
          </Accordion>
        ))}
